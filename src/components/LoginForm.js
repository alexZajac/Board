    ...
    fire
      ...
      .catch(error => {
        ...
        if (this.errorMessage !== null) {
          ...
          }, 2300); //gets back to null after rendering the error animation
        }
      });
  ...
  SignUpWithGoogle() {
    ...
    firebase.auth().onAuthStateChanged(user => {
      if (user) {
        ...
        localStorage.setItem("userId", user.uid);
        if (this.redirectToBoard)
          window.location = "/Board/board/" + redirectBoardId;
        else window.location = "/Board/dashboard";
      }
    });
  }
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="col-md-6" id="login-wrapper">
          <br />
          <p id="msgLogin">Nice to see you again !</p>
          <br />
          <form onSubmit={this.HandleLogin}>
            <div className="form-group">
              <label className="labelLogin" htmlFor="exampleInputEmail">
                Email address
              </label>
              <input
                value={email}
              ...
              <small id="emailHelp" className="form-text text-muted">
                We'll never disclose any information
              </small>
            </div>
            <br />
            <div className="form-group">
              <label className="labelLogin" htmlFor="exampleInputPassword">
                Password
              </label>
              <input
                value={password}
            ...
            <div>
              <p onClick={this.SignUpWithGoogle} className="SignupBtn google" />
              <p
